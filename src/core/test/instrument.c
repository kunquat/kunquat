...
START_TEST (new)
{
	...
	Instrument* ins = new_Instrument(INS_TYPE_DEBUG, bufs, 100);
	if (ins == NULL)
	{
...
START_TEST (new_break_type_inv1)
{
	...
	frame_t buf_r[1] = { 0 };
	frame_t* bufs[2] = { buf_l, buf_r };
	Instrument* ins = new_Instrument(INS_TYPE_NONE, bufs, 1);
	del_Instrument(ins);
}
END_TEST
...
START_TEST (new_break_type_inv2)
{
	...
	frame_t buf_r[1] = { 0 };
	frame_t* bufs[2] = { buf_l, buf_r };
	Instrument* ins = new_Instrument(INS_TYPE_LAST, bufs, 1);
	del_Instrument(ins);
}
END_TEST
...
{
	Instrument* ins = new_Instrument(INS_TYPE_DEBUG, NULL, 1);
	del_Instrument(ins);
}
END_TEST
...
START_TEST (new_break_buf_len_inv)
{
	...
	frame_t buf_r[1] = { 0 };
	frame_t* bufs[2] = { buf_l, buf_r };
	Instrument* ins = new_Instrument(INS_TYPE_DEBUG, bufs, 0);
	del_Instrument(ins);
}
END_TEST
#endif
...
START_TEST (mix)
{
	...
	frame_t buf_r[128] = { 0 };
	frame_t* bufs[2] = { buf_l, buf_r };
	Instrument* ins = new_Instrument(INS_TYPE_DEBUG, bufs, 128);
	if (ins == NULL)
	{
		fprintf(stderr, "new_Instrument() returned NULL -- out of memory?\n");
		abort();
...
START_TEST (mix_break_state_null)
{
	...
	frame_t buf_r[1] = { 0 };
	frame_t* bufs[2] = { buf_l, buf_r };
	Instrument* ins = new_Instrument(INS_TYPE_DEBUG, bufs, 1);
	if (ins == NULL)
	{
		fprintf(stderr, "new_Instrument() returned NULL -- out of memory?\n");
		return;
