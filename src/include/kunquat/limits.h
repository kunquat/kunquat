...
#define KQT_TUNING_TABLE_MIDDLE_OCTAVE_UNBIASED 8
#define KQT_TUNING_TABLE_NOTE_MODS 16
#define KQT_TUNING_TABLE_NOTES 128
#define KQT_TUNING_TABLE_OCTAVE_BIAS (-3)
#define KQT_TUNING_TABLE_OCTAVE_FIRST KQT_TUNING_TABLE_OCTAVE_BIAS
#define KQT_TUNING_TABLE_MIDDLE_OCTAVE \
    (KQT_TUNING_TABLE_MIDDLE_OCTAVE_UNBIASED + KQT_TUNING_TABLE_OCTAVE_BIAS)
#define KQT_TUNING_TABLE_OCTAVE_LAST \
    (KQT_TUNING_TABLE_OCTAVES - 1 + KQT_TUNING_TABLE_OCTAVE_BIAS)
