...
START_TEST(Trivial_effect_is_identity)
{
    ...
    set_data("au_01/p_manifest.json", "[0, { \"type\": \"effect\" }]");
    set_data("au_01/in_00/p_manifest.json", "[0, {}]");
    set_data("au_01/out_00/p_manifest.json", "[0, {}]");
    set_data("au_01/p_connections.json", "[0, [ [\"in_00\", \"out_00\"] ]]");
...
START_TEST(Effect_with_default_volume_dsp_is_identity)
{
    ...
    set_data("au_01/in_00/p_manifest.json", "[0, {}]");
    set_data("au_01/out_00/p_manifest.json", "[0, {}]");
    set_data("au_01/proc_00/p_manifest.json", "[0, { \"type\": \"volume\" }]");
    set_data("au_01/proc_00/p_signal_type.json", "[0, \"mixed\"]");
...
START_TEST(Effect_with_double_volume_dsp_and_bypass_triples_volume)
{
    ...
    set_data("au_01/proc_00/in_00/p_manifest.json", "[0, {}]");
    set_data("au_01/proc_00/out_00/p_manifest.json", "[0, {}]");
    set_data("au_01/proc_00/c/p_f_volume.json", "[0, 6]");
    set_data("au_01/p_connections.json",
            "[0,"
            "[ [\"in_00\", \"out_00\"],"
            "  [\"in_00\", \"proc_00/C/in_00\"],"
...
START_TEST(Connect_instrument_effect_with_unconnected_dsp_and_mix)
{
    ...
    set_data("au_00/p_manifest.json", "[0, { \"type\": \"instrument\" }]");
    set_data("au_00/out_00/p_manifest.json", "[0, {}]");
    set_data("au_00/au_01/p_manifest.json", "[0, { \"type\": \"effect\" }]");
    set_data("au_00/au_01/in_00/p_manifest.json", "[0, {}]");
    set_data("au_00/au_01/out_00/p_manifest.json", "[0, {}]");
    set_data("au_00/au_01/proc_00/p_manifest.json", "[0, { \"type\": \"volume\" }]");
    set_data("au_00/au_01/proc_00/in_00/p_manifest.json", "[0, {}]");
    set_data("au_00/au_01/proc_00/out_00/p_manifest.json", "[0, {}]");
    set_data("au_00/p_connections.json",
            "[0, [ [\"au_01/out_00\", \"out_00\"] ]]");
