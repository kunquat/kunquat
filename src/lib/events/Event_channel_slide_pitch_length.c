...
static void Event_channel_slide_pitch_length_process(Event_channel* event, Channel* ch);
...
static void Event_channel_slide_pitch_length_process(Event_channel* event, Channel* ch)
{
    ...
    assert(voice != NULL);
    Event_channel_slide_pitch_length* slide_pitch_length = (Event_channel_slide_pitch_length*)event;
