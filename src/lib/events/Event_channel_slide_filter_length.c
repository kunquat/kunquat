...
static void Event_channel_slide_filter_length_process(Event_channel* event, Channel* ch);
...
static void Event_channel_slide_filter_length_process(Event_channel* event, Channel* ch)
{
    ...
    assert(voice != NULL);
    Event_channel_slide_filter_length* slide_filter_length = (Event_channel_slide_filter_length*)event;
