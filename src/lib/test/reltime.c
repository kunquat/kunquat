...
{
    Reltime_set(&(Reltime){ .beats = 0 }, 0, KQT_RELTIME_BEAT);
}
END_TEST
...
#define CMPTEXT(c) ((c) < 0 ? "smaller" : ((c) > 0 ? "greater" : "equal"))
    ...
    Reltime_set(r1, INT64_MIN, KQT_RELTIME_BEAT - 1);
    Reltime_set(r2, INT64_MIN, KQT_RELTIME_BEAT - 1);
    res = Reltime_cmp(r1, r2);
    fail_unless(res == 0,
            "Reltime_cmp() returned %s instead of equal.", CMPTEXT(res));
    ...
    fail_unless(res == 0,
            "Reltime_cmp() returned %s instead of equal.", CMPTEXT(res));
    Reltime_set(r1, INT64_MIN + 1, KQT_RELTIME_BEAT - 1);
    Reltime_set(r2, INT64_MIN + 1, KQT_RELTIME_BEAT - 1);
    res = Reltime_cmp(r1, r2);
    fail_unless(res == 0,
            "Reltime_cmp() returned %s instead of equal.", CMPTEXT(res));
    ...
    fail_unless(res == 0,
            "Reltime_cmp() returned %s instead of equal.", CMPTEXT(res));
    Reltime_set(r1, -1, KQT_RELTIME_BEAT - 1);
    ...
    fail_unless(res == 0,
            "Reltime_cmp() returned %s instead of equal.", CMPTEXT(res));
    Reltime_set(r1, 0, KQT_RELTIME_BEAT - 1);
    ...
    fail_unless(res == 0,
            "Reltime_cmp() returned %s instead of equal.", CMPTEXT(res));
    Reltime_set(r1, INT64_MAX - 1, KQT_RELTIME_BEAT - 1);
    Reltime_set(r2, INT64_MAX - 1, KQT_RELTIME_BEAT - 1);
    res = Reltime_cmp(r1, r2);
    fail_unless(res == 0,
            "Reltime_cmp() returned %s instead of equal.", CMPTEXT(res));
    ...
    fail_unless(res == 0,
            "Reltime_cmp() returned %s instead of equal.", CMPTEXT(res));
    Reltime_set(r1, INT64_MAX, KQT_RELTIME_BEAT - 1);
    ...
    fail_unless(res > 0,
            "Reltime_cmp() returned %s instead of greater.", CMPTEXT(res));
    Reltime_set(r1, INT64_MIN, KQT_RELTIME_BEAT - 2);
    Reltime_set(r2, INT64_MIN, KQT_RELTIME_BEAT - 1);
    res = Reltime_cmp(r1, r2);
    fail_unless(res < 0,
            "Reltime_cmp() returned %s instead of smaller.", CMPTEXT(res));
    ...
    fail_unless(res > 0,
            "Reltime_cmp() returned %s instead of greater.", CMPTEXT(res));
    Reltime_set(r1, -1, KQT_RELTIME_BEAT - 2);
    Reltime_set(r2, -1, KQT_RELTIME_BEAT - 1);
    res = Reltime_cmp(r1, r2);
    fail_unless(res < 0,
            "Reltime_cmp() returned %s instead of smaller.", CMPTEXT(res));
    ...
    fail_unless(res > 0,
            "Reltime_cmp() returned %s instead of greater.", CMPTEXT(res));
    Reltime_set(r1, 0, KQT_RELTIME_BEAT - 2);
    Reltime_set(r2, 0, KQT_RELTIME_BEAT - 1);
    res = Reltime_cmp(r1, r2);
    fail_unless(res < 0,
            "Reltime_cmp() returned %s instead of smaller.", CMPTEXT(res));
    ...
    fail_unless(res > 0,
            "Reltime_cmp() returned %s instead of greater.", CMPTEXT(res));
    Reltime_set(r1, INT64_MAX, KQT_RELTIME_BEAT - 2);
    Reltime_set(r2, INT64_MAX, KQT_RELTIME_BEAT - 1);
    res = Reltime_cmp(r1, r2);
    fail_unless(res < 0,
            "Reltime_cmp() returned %s instead of smaller.", CMPTEXT(res));
...
{
    Reltime* br = &(Reltime){ .beats = 0, .rem = KQT_RELTIME_BEAT };
    Reltime_cmp(br, Reltime_init(&(Reltime){ .beats = 0 }));
}
END_TEST
...
START_TEST (add)
{
    ...
    Reltime_set(r1, 0, KQT_RELTIME_BEAT - 1);
    Reltime_set(r2, 0, KQT_RELTIME_BEAT - 1);
    Reltime_set(exp, 1, KQT_RELTIME_BEAT - 2);
    ret = Reltime_add(res, r1, r2);
    fail_unless(ret == res,
            "Reltime_add() returned %p instead of %p.", ret, res);
    fail_unless(Reltime_cmp(res, exp) == 0,
...
START_TEST (sub)
{
    ...
    Reltime_set(r1, -1, 0);
    Reltime_set(r2, -1, 1);
    Reltime_set(exp, -1, KQT_RELTIME_BEAT - 1);
    ...
    Reltime_set(r1, -1, 0);
    Reltime_set(r2, 0, 1);
    Reltime_set(exp, -2, KQT_RELTIME_BEAT - 1);
    ret = Reltime_sub(res, r1, r2);
    fail_unless(ret == res,
            "Reltime_sub() returned %p instead of %p.", ret, res);
    fail_unless(Reltime_cmp(res, exp) == 0,
...
START_TEST (copy)
{
    ...
    Reltime_set(src, INT64_MAX, KQT_RELTIME_BEAT - 1);
    ...
    Reltime_set(src, 0, KQT_RELTIME_BEAT - 1);
    ret = Reltime_copy(dest, src);
    fail_unless(ret == dest,
            "Reltime_copy() returned %p instead of %p.", ret, dest);
    fail_unless(Reltime_cmp(dest, src) == 0,
    ...
    Reltime_set(src, -1, KQT_RELTIME_BEAT - 1);
    ret = Reltime_copy(dest, src);
    fail_unless(ret == dest,
            "Reltime_copy() returned %p instead of %p.", ret, dest);
    fail_unless(Reltime_cmp(dest, src) == 0,
    ...
    Reltime_set(src, INT64_MIN, KQT_RELTIME_BEAT - 1);
    ret = Reltime_copy(dest, src);
    fail_unless(ret == dest,
            "Reltime_copy() returned %p instead of %p.", ret, dest);
    fail_unless(Reltime_cmp(dest, src) == 0,
...
START_TEST (toframes)
{
    ...
    Reltime_set(r, 0, KQT_RELTIME_BEAT / 2);
    res = Reltime_toframes(r, 60, 44100);
    fail_unless(res == 22050,
            "Reltime_toframes() returned %ld instead of 22050.", (long)res);
    res = Reltime_toframes(r, 120, 44100);
    ...
    Reltime_set(r, 1, KQT_RELTIME_BEAT / 2);
    res = Reltime_toframes(r, 60, 44100);
...
{
    Reltime_toframes(Reltime_set(RELTIME_AUTO, -1, KQT_RELTIME_BEAT - 1), 1, 1);
}
END_TEST
...
START_TEST (fromframes)
{
    ...
    Reltime_set(exp, 0, KQT_RELTIME_BEAT / 2);
