...
bool Event_processor_set_bool_process(
...
bool Event_processor_set_bool_name_process(
        const Device_impl* dimpl,
        Device_state* dstate,
        Channel* ch,
        const Value* value)
...
bool Event_processor_set_float_process(
        const Device_impl* dimpl,
        Device_state* dstate,
        Channel* ch,
        const Value* value)
...
bool Event_processor_set_float_name_process(
        const Device_impl* dimpl,
        Device_state* dstate,
        Channel* ch,
        const Value* value)
...
bool Event_processor_set_int_process(
        const Device_impl* dimpl,
        Device_state* dstate,
        Channel* ch,
        const Value* value)
...
bool Event_processor_set_int_name_process(
        const Device_impl* dimpl,
        Device_state* dstate,
        Channel* ch,
        const Value* value)
...
bool Event_processor_set_tstamp_process(
        const Device_impl* dimpl,
        Device_state* dstate,
        Channel* ch,
        const Value* value)
...
bool Event_processor_set_tstamp_name_process(
        const Device_impl* dimpl,
        Device_state* dstate,
        Channel* ch,
        const Value* value)
