...
EVENT_AU_DEF("a.Bn",        set_cv_bool_name,           STRING,     v_var_name)
EVENT_AU_DEF("a.B",         set_cv_bool_value,          BOOL,       v_any_bool)
EVENT_AU_DEF("a.In",        set_cv_int_name,            STRING,     v_var_name)
...
EVENT_AU_DEF("a.Tn",        set_cv_tstamp_name,         STRING,     v_var_name)
