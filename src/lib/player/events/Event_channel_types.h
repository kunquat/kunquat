...
EVENT_CHANNEL_DEF(".cvn",   set_cv_name,                STRING,     v_var_name)
EVENT_CHANNEL_DEF(".cv",    set_cv_value,               REALTIME,   v_finite_rt)
EVENT_CHANNEL_DEF("/cv",    slide_cv_target,            FLOAT,      v_finite_float)
EVENT_CHANNEL_DEF("/=cv",   slide_cv_length,            TSTAMP,     v_nonneg_ts)
EVENT_CHANNEL_DEF("oscv",   osc_speed_cv,               FLOAT,      v_nonneg_float)
EVENT_CHANNEL_DEF("odcv",   osc_depth_cv,               FLOAT,      v_nonneg_float)
EVENT_CHANNEL_DEF("o/=scv", osc_speed_slide_cv,         TSTAMP,     v_nonneg_ts)
EVENT_CHANNEL_DEF("o/=dcv", osc_depth_slide_cv,         TSTAMP,     v_nonneg_ts)
EVENT_CHANNEL_DEF("->cv+",  carry_cv_on,                NONE,       NULL)
EVENT_CHANNEL_DEF("->cv-",  carry_cv_off,               NONE,       NULL)
