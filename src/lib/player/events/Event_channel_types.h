...
EVENT_CHANNEL_DEF(".xi",    set_init_expression,        STRING,     v_var_name)
EVENT_CHANNEL_DEF(".x",     apply_expression,           STRING,     v_var_name)
EVENT_CHANNEL_DEF("->x+",   carry_expression_on,        NONE,       NULL)
EVENT_CHANNEL_DEF("->x-",   carry_expression_off,       NONE,       NULL)
